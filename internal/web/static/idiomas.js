...
const IDIOMAS = {
  es: {
    ...
    "f.trampa": "Solo cebos mordidos",
    "f.servicios": "Todos los servicios",
    "f.limpiar": "Quitar filtros",
    "cargando": "Cargando…",
    "cargando.mapa": "Cargando mapa…",
    "sec.intel": "Inteligencia",
    "sec.intel.sub": "C2, familias de botnet y destinos de t\u00fanel agregados de todo lo capturado",
    "tab.c2": "C2",
    "tab.botnets": "Botnets",
    "tab.tuneles": "T\u00faneles",
    "intel.ver": "ver ataques",
    "sec.c2": "Infraestructura C2",
    "sec.c2.sub": "Servidores de mando y control detectados en muestras, exploits y descargas",
    "sec.botnets": "Familias de botnet",
    "sec.botnets.sub": "Clasificaci\u00f3n por firma de los ataques con comandos reconocibles",
    "sec.tuneles": "Destinos de t\u00fanel",
    "sec.tuneles.sub": "A d\u00f3nde intentan reenviar tr\u00e1fico a trav\u00e9s del honeypot",
    "c2.host": "Host",
    "c2.fuentes": "Fuentes",
    "c2.veces": "Veces visto",
    "c2.familias": "Familia",
    "c2.fuente.callback": "callback de exploit",
    "c2.fuente.muestra": "embebido en muestra",
    "c2.fuente.descarga": "servidor de descarga",
    "bot.episodios": "episodios",
    "bot.ips": "IPs",
    "bot.ejemplo": "Ejemplo de comandos",
    "tun.destino": "Destino",
    "tun.veces": "Peticiones",
    "tun.ips": "IPs",
  ...
  en: {
    ...
    "sec.intel.sub": "C2, botnet families, and tunnel destinations aggregated from all captures",
    "tab.c2": "C2",
    "tab.botnets": "Botnets",
    "tab.tuneles": "Tunnels",
    "intel.ver": "see attacks",
    "sec.c2": "C2 Infrastructure",
    "sec.c2.sub": "Command and control servers found in samples, exploits, and downloads",
    "sec.botnets": "Botnet families",
    "sec.botnets.sub": "Classification by signature of attacks with recognizable commands",
    "sec.tuneles": "Tunnel destinations",
    "sec.tuneles.sub": "Where they try to relay traffic through the honeypot",
    "c2.host": "Host",
    "c2.fuentes": "Sources",
    "c2.veces": "Times seen",
    "c2.familias": "Family",
    "c2.fuente.callback": "exploit callback",
    "c2.fuente.muestra": "embedded in sample",
    "c2.fuente.descarga": "download server",
    "bot.episodios": "episodes",
    "bot.ips": "IPs",
    "bot.ejemplo": "Example commands",
    "tun.destino": "Destination",
    "tun.veces": "Requests",
    "tun.ips": "IPs",
...
Object.assign(IDIOMAS.es, {
  ...
  "sev.roce": "roce", "sev.tanteo": "tanteo", "sev.acceso": "acceso", "sev.intrusion": "intrusión", "sev.trampa": "trampa",
  ...
  "grav.trampa": "Cebo mordido — reutilizaron una credencial señuelo",
...
Object.assign(IDIOMAS.en, {
  ...
  "sev.roce": "knock", "sev.tanteo": "probe", "sev.acceso": "access", "sev.intrusion": "intrusion", "sev.trampa": "trap",
  ...
  "grav.trampa": "Bait taken — reused a decoy credential",
...
Object.assign(IDIOMAS.es, {
  ...
  "dato.c2.urls": "URLs dentro (C2/2ª fase)", "dato.c2.ips": "IPs dentro (C2)",
  "amenaza.botnet": "Botnet IoT", "amenaza.dropper": "Dropper", "amenaza.minero": "Minero", "amenaza.webshell": "Webshell", "amenaza.muestra": "Ejecutable", "amenaza.prueba": "Prueba",
...
Object.assign(IDIOMAS.en, {
  ...
  "dato.c2.urls": "URLs inside (C2/stage 2)", "dato.c2.ips": "IPs inside (C2)",
  "amenaza.botnet": "IoT botnet", "amenaza.dropper": "Dropper", "amenaza.minero": "Miner", "amenaza.webshell": "Webshell", "amenaza.muestra": "Executable", "amenaza.prueba": "Probe",
...
Object.assign(IDIOMAS.es, {
  ...
  "cfg.inf.tope": "Tope global de llamadas a la IA al día (opcional)",
  "cfg.inf.tope.small": "Cada modelo ya se limita solo por su proveedor; k0Pot salta al siguiente cuando uno se agota. Este es un techo global opcional: <b>0 = sin límite</b> (recomendado con planes gratuitos).",
  ...
  "cfg.av.trampa": "Cebo mordido — reutilizaron una credencial señuelo",
...
Object.assign(IDIOMAS.en, {
  ...
  "cfg.inf.tope": "Global daily cap on AI calls (optional)",
  "cfg.inf.tope.small": "Each model already self-limits via its provider; k0Pot falls back to the next when one runs out. This is an optional global ceiling: <b>0 = no limit</b> (recommended for free plans).",
  ...
  "cfg.av.trampa": "Bait taken — reused a decoy credential",
